...
<!--ns0071-->
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo \yii\helpers\Url::to(['/about/index'])?>">
                    <i class="fas fa-address-card"></i>
                    <span>About</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo \yii\helpers\Url::to(['/contact/index'])?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo \yii\helpers\Url::to(['/services/index'])?>">
                    <i class="fas fa-satellite"></i>
                    <span>Services</span></a>
            </li>    </li>-->
            <!--            <li class="nav-item">-->
            <!--                <a class="nav-link" href="--><?php //echo \yii\helpers\Url::to(['/resume/index'])?><!--">-->
            <!--                    <i class="fas fa-sitemap"></i>-->
            <!--                    <span>resume</span></a>-->
            <!--            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?php echo \yii\helpers\Url::to(['/team/index'])?>">
